...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "managed portfolio company Indonesia",
    "manpower company investment",
    "outsourcing company acquisition",
    "FMCG manpower company",
    "brand activation company Indonesia",
    "strategic investment opportunity",
    "outsourcing business transformation",
    "investor readiness Indonesia",
    "M&A outsourcing company",
  ],
